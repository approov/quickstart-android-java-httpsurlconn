...
```
implementation 'com.github.approov:approov-service-httpsurlconn:2.7.0'
```
...
> **IMPORTANT:** The registration takes up to 30 seconds to propagate across the Approov Cloud Infrastructure, therefore don't try to run the app again before this time as elapsed. During development of your app you ensure it [always passses](https://approov.io/docs/latest/approov-usage-documentation/#adding-a-device-security-policy) so you dp not have to register the APK each time you modify it.
